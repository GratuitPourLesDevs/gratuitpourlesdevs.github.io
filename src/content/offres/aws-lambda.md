...
alertes:
  - type: finance
    ...
    detail: Les requêtes et la durée d’exécution hors quota sont facturées selon la région et l’architecture.
  - type: finance
    niveau: important
    libelle: Services associés facturables
    detail: Les logs, transferts, stockages et services AWS connectés peuvent générer des frais séparés.
