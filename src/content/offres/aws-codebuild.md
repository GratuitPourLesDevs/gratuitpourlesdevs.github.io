...
alertes:
  - type: finance
    ...
    detail: Le temps de build dépassant le quota gratuit est facturé selon le calcul et la région choisis.
  - type: finance
    niveau: important
    libelle: Services associés facturables
    detail: Les artefacts S3, logs CloudWatch, clés KMS et pipelines peuvent être facturés séparément.
