---
nom: Neocities
accroche: Hébergement statique communautaire sans publicité pour créer et publier librement son propre site web.
type: Service managé
categorie: hebergement-web
formule: 'Free : 1 Go de stockage et 200 Go de bande passante'
inclus:
- 1 Go de stockage
- 200 Go de bande passante
- Sous-domaine Neocities
- SSL
- CDN Anycast mondial
- Éditeur web
- CLI et outils de publication
- Aucune publicité imposée
conditions: []
restrictions:
- Les domaines personnalisés sont réservés au plan Supporter
- Hébergement principalement statique
alertes: []
usages:
